...
- `enable_all_levels`: make every authored campaign level and well available for this session so environment variants can be reviewed.
...
Level access is also session-only and is not written to campaign or account saves.
